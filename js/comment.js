...
$(document).ready(function(){
 $("#commentSubmission").click(function () {
  ...
  if ((userName === "") || (userComment === "")) {
   $("#notValidInput").removeClass("displayNone");
   $("#notValidInput").addClass("displayBlock");
   $("#closeThisNoFields").click(function () {
    $("#notValidInput").removeClass("displayBlock");
    $("#notValidInput").addClass("displayNone");
  });
 }
 else {
  $("#nameInput").val("");
